...
def all_analyzers(cache_names=["PFIFO", "PLRU", "PLFU"]):
    ...
    p_analyzer13  = mp.Process(target=Analyzer, args=(analyzer_queues[12],30,1000000,True,"CHR_"+cache_name+"_50_time", "CHR_"+cache_name+"_50_regular", "CHR_"+cache_name+"_50_final",))
    p_analyzer14 = mp.Process(target=Analyzer, args=(analyzer_queues[13],30,1000000,True,"CHR_"+cache_name+"_100_time", "CHR_"+cache_name+"_100_regular", "CHR_"+cache_name+"_100_final",))
    p_analyzer15 = mp.Process(target=Analyzer, args=(analyzer_queues[14],30,1000000,True,"CHR_"+cache_name+"_200_time", "CHR_"+cache_name+"_200_regular", "CHR_"+cache_name+"_200_final",))
    p_analyzer16 = mp.Process(target=Analyzer, args=(analyzer_queues[15],30,1000000,True,"CHR_"+cache_name+"_500_time", "CHR_"+cache_name+"_500_regular", "CHR_"+cache_name+"_500_final",))
    p_analyzer17 = mp.Process(target=Analyzer, args=(analyzer_queues[16],30,1000000,True,"CHR_"+cache_name+"_1000_time", "CHR_"+cache_name+"_1000_regular", "CHR_"+cache_name+"_1000_final",))
    p_analyzer18 = mp.Process(target=Analyzer, args=(analyzer_queues[17],30,1000000,True,"CHR_"+cache_name+"_2000_time", "CHR_"+cache_name+"_2000_regular", "CHR_"+cache_name+"_2000_final",))
    p_analyzer19 = mp.Process(target=Analyzer, args=(analyzer_queues[18],30,1000000,True,"CHR_"+cache_name+"_5000_time", "CHR_"+cache_name+"_5000_regular", "CHR_"+cache_name+"_5000_final",))
    p_analyzer20 = mp.Process(target=Analyzer, args=(analyzer_queues[19],30,1000000,True,"CHR_"+cache_name+"_10000_time", "CHR_"+cache_name+"_10000_regular", "CHR_"+cache_name+"_10000_final",))
    p_analyzer21 = mp.Process(target=Analyzer, args=(analyzer_queues[20],30,1000000,True,"CHR_"+cache_name+"_20000_time", "CHR_"+cache_name+"_20000_regular", "CHR_"+cache_name+"_20000_final",))
    p_analyzer22 = mp.Process(target=Analyzer, args=(analyzer_queues[21],30,1000000,True,"CHR_"+cache_name+"_50000_time", "CHR_"+cache_name+"_50000_regular", "CHR_"+cache_name+"_50000_final",))
    p_analyzer23 = mp.Process(target=Analyzer, args=(analyzer_queues[22],30,1000000,True,"CHR_"+cache_name+"_100000_time", "CHR_"+cache_name+"_100000_regular", "CHR_"+cache_name+"_100000_final",))
    p_analyzer24 = mp.Process(target=Analyzer, args=(analyzer_queues[23],30,1000000,True,"CHR_"+cache_name+"_1000000_time", "CHR_"+cache_name+"_1000000_regular", "CHR_"+cache_name+"_1000000_final",))

    cache_name = cache_names[2]
    p_analyzer25  = mp.Process(target=Analyzer, args=(analyzer_queues[24],30,1000000,True,"CHR_"+cache_name+"_50_time", "CHR_"+cache_name+"_50_regular", "CHR_"+cache_name+"_50_final",))
    p_analyzer26 = mp.Process(target=Analyzer, args=(analyzer_queues[25],30,1000000,True,"CHR_"+cache_name+"_100_time", "CHR_"+cache_name+"_100_regular", "CHR_"+cache_name+"_100_final",))
    p_analyzer27 = mp.Process(target=Analyzer, args=(analyzer_queues[26],30,1000000,True,"CHR_"+cache_name+"_200_time", "CHR_"+cache_name+"_200_regular", "CHR_"+cache_name+"_200_final",))
    p_analyzer28 = mp.Process(target=Analyzer, args=(analyzer_queues[27],30,1000000,True,"CHR_"+cache_name+"_500_time", "CHR_"+cache_name+"_500_regular", "CHR_"+cache_name+"_500_final",))
    p_analyzer29 = mp.Process(target=Analyzer, args=(analyzer_queues[28],30,1000000,True,"CHR_"+cache_name+"_1000_time", "CHR_"+cache_name+"_1000_regular", "CHR_"+cache_name+"_1000_final",))
    p_analyzer30 = mp.Process(target=Analyzer, args=(analyzer_queues[29],30,1000000,True,"CHR_"+cache_name+"_2000_time", "CHR_"+cache_name+"_2000_regular", "CHR_"+cache_name+"_2000_final",))
    p_analyzer31 = mp.Process(target=Analyzer, args=(analyzer_queues[30],30,1000000,True,"CHR_"+cache_name+"_5000_time", "CHR_"+cache_name+"_5000_regular", "CHR_"+cache_name+"_5000_final",))
    p_analyzer32 = mp.Process(target=Analyzer, args=(analyzer_queues[31],30,1000000,True,"CHR_"+cache_name+"_10000_time", "CHR_"+cache_name+"_10000_regular", "CHR_"+cache_name+"_10000_final",))
    p_analyzer33 = mp.Process(target=Analyzer, args=(analyzer_queues[32],30,1000000,True,"CHR_"+cache_name+"_20000_time", "CHR_"+cache_name+"_20000_regular", "CHR_"+cache_name+"_20000_final",))
    p_analyzer34 = mp.Process(target=Analyzer, args=(analyzer_queues[33],30,1000000,True,"CHR_"+cache_name+"_50000_time", "CHR_"+cache_name+"_50000_regular", "CHR_"+cache_name+"_50000_final",))
    p_analyzer35 = mp.Process(target=Analyzer, args=(analyzer_queues[34],30,1000000,True,"CHR_"+cache_name+"_100000_time", "CHR_"+cache_name+"_100000_regular", "CHR_"+cache_name+"_100000_final",))
    p_analyzer36 = mp.Process(target=Analyzer, args=(analyzer_queues[35],30,1000000,True,"CHR_"+cache_name+"_1000000_time", "CHR_"+cache_name+"_1000000_regular", "CHR_"+cache_name+"_1000000_final",))
