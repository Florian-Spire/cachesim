...
class SSOCache(Cache):
    """
    Smallest size out cache model.
    """
...
class ProtectedSSOCache(SSOCache):
    """
    Same as SSOCache, but big (> 10% of total cache size) object are not allowed to enter the cache.
    """
